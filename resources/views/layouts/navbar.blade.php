		...
		<div class="row visible-xs">
			<div class="col-xs-12">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{ subdomainRoute('front.index') }}">
			...
			<div class="col-xs-12">
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="{{ subdomainRoute('front.day') }}"
								 class="{{ Route::currentRouteNamed('front.day') ? 'active': '' }}">{{ $mode === 'birthday' ? 'Birthday' : 'Wedding Day' }}
							</a>
						</li>
						<li>
							<a href="{{ subdomainRoute('front.rsvp') }}"
								 class="{{ Route::currentRouteNamed('front.rsvp') ? 'active': '' }}">Online RSVP
							</a>
						</li>
						@auth
							<li class="visible-xs"><a href="{{ subdomainRoute('admin') }}" target="_blank">Backend</a></li>
						@endauth
					</ul>

					@auth
						<ul class="nav navbar-nav navbar-right visible-md visible-lg">
							<li><a href="{{ subdomainRoute('admin') }}" target="_blank">Backend</a></li>
						</ul>
					@endauth
				</div> <!-- /.navbar-collapse -->
			</div>
