    ...
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        {{--<h1 class="panel-title">{{ trans('laravel-filemanager::lfm.title-panel') }}</h1>--}}
				<h1 class="panel-title">My Uploaded Files</h1>
      </div>
    </div>
    <div class="row">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ subdomainRoute('unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
